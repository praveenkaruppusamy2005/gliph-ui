...
function MusicPlayerHeroTablet({ isDark }: { isDark: boolean }) {
  return (
    <div className={`relative mx-auto w-[420px] aspect-[3/5] rounded-[2.5rem] border-[14px] overflow-hidden shadow-2xl ${isDark ? 'border-[#18181b] bg-[#070711] shadow-emerald-500/10' : 'border-zinc-900 bg-[#070711] shadow-black/25'}`}>
